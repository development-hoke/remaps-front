...
class ZsubscriptionPayment extends Model
{
    use CrudTrait;
     ...
     */
    protected $fillable = [
        'zsubscription_id', 'pay_txn_id', 'next_billing_date', 'last_payment_date', 'last_payment_amount', 'failed_payment_count', 'status'
    ];
    ...
    {
        return $this->belongsTo('App\Models\Zsubscription');
    }
