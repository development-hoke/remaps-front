    ...
    public function index()
    {
        try{
            ...
            if ($this->user->tuningEVCCreditGroup)
                $data['groupEVCCreditTires']  = $this->user->tuningEVCCreditGroup->tuningCreditTires()->withPivot('from_credit', 'for_credit')->wherePivot('from_credit', '!=', 0.00)->orderBy('amount', 'ASC')->get();
            else
