 ...
 */
class ZSubscriptionPaymentCrudController extends MasterController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\ZsubscriptionPayment');
        $this->crud->setRoute('admin/zsubscription-payment');
        $this->crud->setEntityNameStrings('zsubscription payment', 'zsubscription payments');
     ...
     * @return $response
     */
    public function invoice(\App\Models\ZsubscriptionPayment $subscription_payment){
