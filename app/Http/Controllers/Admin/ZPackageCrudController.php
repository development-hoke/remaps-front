...
/**
 * Class TestPackageCrudController
 * @param App\Http\Controllers\Admin
 * @return CrudPanel $crud
 */
class ZPackageCrudController extends MasterController
{
    ...
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Zpackage');
        $this->crud->setRoute('admin/zpackage');
        $this->crud->setEntityNameStrings('zpackage', 'zpackages');
    ...
    public function update(UpdateRequest $request){
        try {
            ...
            $url = "https://api.sandbox.paypal.com/v1/billing/plans/P-1M592657LP7904156L6LKNQA/update-pricing-schemes";
